...
export async function POST() {
  try {
    console.log('[Database Reset API] Truncating tables...');
    
    // Programmatic DB clean
    ...
    console.log('[Database Reset API] Generating 1000 shoppers...');
    ...
    console.log('[Database Reset API] Generating 5000 orders...');
    ...
    for (let i = 0; i < 5000; i++) {
      ...
      else amount = Math.floor(Math.random() * 3000) + 100;
    ...
    console.log('[Database Reset API] Generating default segments...');
    ...
    console.log('[Database Reset API] Creating campaign and event logs...');
    ...
    console.log('[Database Reset API] Success!');
    return NextResponse.json({
      success: true,
      message: 'Database reset and seed completed successfully programmatically!'
    });
  } catch (error: any) {
    console.error('[Database Reset API] Fatal Error:', error);
    return NextResponse.json({
